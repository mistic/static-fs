...
module.exports = async () => {
  try {
    ...
    execa.commandSync('yarn install --no-lockfile', { cwd: 'test/helpers/mock_project' });
    execa.commandSync('yarn build', { cwd: 'test/helpers/mock_project/node_modules/static-fs' });
